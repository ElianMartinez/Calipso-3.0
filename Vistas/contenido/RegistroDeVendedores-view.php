                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-group-sm 9 col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" required="" autocomplete="off" class="form-control" id="nombre" name="nombre">
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm  col-sm-6">
          ...
          <div class="card">
            <div class="card-header">
              <form class="form-inline">
                ...
                <button type="button" onclick="imprimir('<?php echo SERVERURL; ?>Vistas/assets/vendor/bootstrap/css/bootstrap.min.css','ZONAS','<?php echo COMPANY; ?>')"  class="btn btn-dark imprimir"
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table id="example" border=1 cellspacing="0" bordercolor="#DCDCDC" class="display table table-hover" style="width:100%" >
                  <thead class="the">
                    <tr>  
      ...
      <div class="card-body">
          <div class="row">
              <div class="col form-group ">
                 ...
                 <input type="text" name="nombreV" id="nombreV" class="form-control" placeholder="Ingrese el nombre del vendedor">
                </div>
          </div>
