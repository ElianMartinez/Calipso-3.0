<div class="dashboard-wrapper">
    ...
    <div class="MostrarGrupos App1">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
          <br>
          <br>
        <h2 id="Titulo" class="text-center">Tipos de Vendedores</h2>
          <div class="card">
            <div class="card-header">
              <form class="form-inline">
                <h4 style="margin-top:12px">Tipos de Vendedores</h4>
                ...
                <button type="button" onclick="imprimir('<?php echo SERVERURL; ?>Vistas/assets/vendor/bootstrap/css/bootstrap.min.css','TIPO DE VENDEDORES','<?php echo COMPANY; ?>')"  class="btn btn-dark imprimir"
...
<br>
    <div class="Registrogrupos col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 App2">
        <div class="card">
            <div class="form-group">
              ...
              <center>
                <h5 class="col-xl-4 col-lg-6 col-md-9 display-7"><span class=" display-7 TituloAE badge badge-primary"></span> Tipo de Vendedor</h5>
              </center>
              ...
              action="<?php echo SERVERURL;?>Ajax/TipoVAjax.php" method="POST">
                <div class="form-row mb-8">
                  <div class="col-lg-6 col-md-6 col-sm-8 ">
                    <label>Nombre del tipo de Vendedor</label>
    ...
    <script>
        ...
        MostrarDatos('<?php echo SERVERURL;?>Ajax/TipoVAjax.php');
